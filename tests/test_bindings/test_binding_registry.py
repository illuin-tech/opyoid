...
from illuin_inject.bindings import Binding, BindingRegistry, FactoryBinding, InstanceBinding
...
class TestBindingRegistry(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.my_type_binding.target_type = MyType
        self.my_type_binding.annotation = None
        self.my_type_annotated_binding = create_autospec(Binding, spec_set=True)
        self.my_type_annotated_binding.target_type = MyType
        self.my_type_annotated_binding.annotation = "my_annotation"
        self.my_type_binding_2 = InstanceBinding(MyType, MyType())
        self.other_type_binding = create_autospec(Binding, spec_set=True)
        self.other_type_binding.target_type = OtherType
        self.other_type_binding.annotation = None
    ...
    def test_get_bindings_from_string_with_name_conflict(self):
        ...
        binding_1.target_type = MyNewType
        ...
        binding_2.target_type = MyNewType
