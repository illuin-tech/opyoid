...
class TestObjectProvider(unittest.TestCase):
    ...
    def test_provide_from_simple_binding_node(self):
        instance = MyType()
        self.dependency_graph.binding_nodes_by_type[MyType] = [
            SimpleBindingNode(InstanceBinding(MyType, instance))
        ]
        self.assertIs(instance, self.object_provider.provide(MyType))

    def test_provide_missing_binding_raises_exception(self):
        with self.assertRaises(NoBindingFound):
            self.object_provider.provide(MyType)
    ...
    def test_provide_multiple_bindings(self):
        ...
        self.assertIs(instance_2, self.object_provider.provide(MyType))
    ...
    def test_provide_from_class_binding(self):
        ...
        self.assertIsInstance(self.object_provider.provide(MyType), MyType)
    ...
    def test_provide_from_parameter_node(self):
        ...
        self.dependency_graph.binding_nodes_by_type[MyParentClass] = [
            SimpleBindingNode(
        ...
        parent = self.object_provider.provide(MyParentClass)
    ...
    def test_provide_list_from_type(self):
        ...
        my_list = self.object_provider.provide(List[MyType])
    ...
    def test_provide_list_from_list(self):
        ...
        self.dependency_graph.binding_nodes_by_type[List[MyType]] = [
    ...
    def test_provide_type_from_class(self):
        ...
        my_type = self.object_provider.provide(Type[MyType])
    ...
    def test_provide_type_from_type(self):
        ...
        self.dependency_graph.binding_nodes_by_type[Type[MyType]] = [
    ...
    def test_provide_type_from_class_without_class_bindings_raises_exception(self):
        ...
        with self.assertRaises(NoBindingFound):
            self.object_provider.provide(Type[MyType])
    ...
    def test_provide_type_list(self):
        ...
        type_list = self.object_provider.provide(List[Type[MyType]])
