...
class SetBindingNodesFactory(BindingNodesFactory):
    """Creates a CollectionBindingNode that groups the target set items binding nodes."""
    ...
    def create(self, target: Target[InjectedT], graph_builder: "GraphBuilder") -> List[BindingNode]:
        ...
        return [CollectionBindingNode(graph_builder.get_and_save_binding_nodes(new_target), set)]
